...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.configure(bg="#4bdbbe")

        # Label
        self.intro_label = Label(self, text = 'Welcome to Real Time Currency Convertor',  fg = 'grey', relief = tk.RAISED, justify = tk.CENTER, borderwidth = 3)
